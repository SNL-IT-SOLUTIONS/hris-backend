...
class PayrollController extends Controller
{
    ...
    public function createPayrollPeriod(Request $request)
    {
        ...
        try {
            ...
            /*
        |--------------------------------------------------------------------------
        | CREATE PAYROLL PERIOD AS DRAFT
        |--------------------------------------------------------------------------
        |
        | IMPORTANT:
        | This method ONLY creates the payroll period.
        |
        | It does NOT:
        | - Process payroll
        | - Calculate salaries
        ...
        |
        | Those should happen when the payroll is processed later.
        |--------------------------------------------------------------------------
        */
        ...
        */
            ...
            return response()->json([
                ...
                'message' =>
                'Payroll period created successfully as draft.',
