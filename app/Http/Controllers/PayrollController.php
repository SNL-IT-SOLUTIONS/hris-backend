            ...
            */
                ...
                foreach ($leaves as $leave) {
                    ...
                    while ($leaveDate->lte($leaveEnd)) {
                        ...
                        |--------------------------------------------------------------------------
                        |
                        | Do not count a leave date if the employee
                        | actually has attendance on that date.
                        |
                        */
            ...
            */
                ...
                */
                    ...
                    */
                        ...
                        if (
                            $holidayType
                            && isset($holidayType->rate)
                        ) {
                            $rate =
                                (float) $holidayType->rate;
                        }
